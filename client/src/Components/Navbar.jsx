        ...
        <div className="flex justify-between items-center h-16">
            ...
            {!adminStatus ? (
              ...
              <>
                ...
                <button
                  ...
                  className="flex items-center px-3 py-2 rounded-md text-sm font-medium text-red-300 hover:text-red-200 transition-colors"
                >
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-yellow-200 hover:text-white hover:bg-green-700 focus:outline-none transition duration-150 ease-in-out"
            >
              {mobileMenuOpen ? (
            ...
            {!adminStatus ? (
              ...
              <>
                ...
                <button
                  ...
                  className="flex items-center w-full px-3 py-2 rounded-md text-base font-medium text-red-300 hover:text-red-200 transition-colors"
                >
                  <FaSignOutAlt className="mr-2" />
                  Logout
                </button>
